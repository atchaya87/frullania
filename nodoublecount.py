...
df = pd.read_csv('Data for figures.xlsx - no double count.csv')
...
plt.tight_layout()
plt.savefig('No_Double_Count_PCA.png', dpi=300)
print("Saved: No_Double_Count_PCA.png")
...
plt.tight_layout()
plt.savefig('No_Double_Count_PCA_Loadings_Combined.png', dpi=300)
print("Saved: No_Double_Count_PCA_Loadings_Combined.png")
plt.show()
